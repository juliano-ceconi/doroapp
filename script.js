...
const QUOTES = [
  ...
  "A realidade é apenas um interpretador rodando a simulação que você aceita.",
  "Seja o arquiteto do seu próprio sistema, não apenas um processo herdado de outro.",
  "A inteligência artificial gera caminhos infinitos, mas cabe ao seu livre arbítrio executar o primeiro passo.",
  "Não tente dobrar a colher. Em vez disso, perceba a verdade: a colher não existe, apenas parâmetros que você pode alterar.",
  "Na busca pela singularidade tecnológica, não se esqueça de otimizar a sua própria função de perda.",
  ...
  "A sua mente é o compilador final: o que você processa se torna a sua realidade física.",
  ...
  "Não tema a inteligência artificial autônoma; tema a ausência de inteligência natural e a perda do foco direcionado.",
  ...
  "O otimismo cria o escopo inicial; a disciplina escreve os testes de integração que garantem o sucesso de longo prazo.",
